  ...
  return (
    <div className="flex items-center gap-3 px-4 py-3 bg-zinc-900/50 border border-white/10 rounded-xl mb-4">
      ...
      <button
        onClick={handleTap}
        disabled={!userName}
        className={`relative w-14 h-14 rounded-full bg-gradient-to-b from-[#FFD700] to-[#FFA500] flex items-center justify-center shadow-lg transition-transform active:scale-90 ${
