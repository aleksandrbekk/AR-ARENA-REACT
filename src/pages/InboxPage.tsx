      ...
      <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4">
        <div className="bg-zinc-900 rounded-2xl p-8 max-w-sm w-full border border-zinc-800">
          ...
          <input
            ...
            className={`w-full px-4 py-3 bg-zinc-800 border rounded-xl text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 ${
          ...
          <button
            ...
            className="w-full mt-4 py-3 bg-gradient-to-r from-yellow-500 to-orange-500 text-black font-bold rounded-xl hover:opacity-90 transition"
          >
            Войти
          </button>
        </div>
          ...
          {filteredConversations.length === 0 ? (
            ...
            filteredConversations.map((conv) => (
              <div
                ...
                className={`p-4 border-b border-zinc-800/50 cursor-pointer hover:bg-zinc-800/50 transition ${
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className={`p-1 rounded transition ${
                            conv.is_starred ? 'text-yellow-500' : 'text-zinc-600 hover:text-zinc-400'
                          }`}
                        >
            ...
            <div className="p-4 border-b border-zinc-800 flex items-center gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  ...
                  {selectedConversation.is_premium && (
                  ...
                  >
                    {msg.is_command && (
                      <div className="text-xs opacity-70 mb-1">
                        Команда: {msg.command_name}
                      </div>
                    )}
                    <p className="whitespace-pre-wrap break-words">{msg.text}</p>
                    <div className={`text-xs mt-1 flex items-center gap-1 ${
                      msg.direction === 'outgoing' ? 'text-black/60 justify-end' : 'text-zinc-500'
                    }`}>
